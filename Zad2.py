...
employee2 = Employee("Jane", "Smith", "2022-02-01", "1985-10-20", "City2", "Street2", "67890", "444-555-666")

book1 = Book(library1, "2022-03-01", "Author1", "Surname1", 200)
book2 = Book(library1, "2022-04-01", "Author2", "Surname2", 250)
book3 = Book(library2, "2022-05-01", "Author3", "Surname3", 300)
book4 = Book(library2, "2022-06-01", "Author4", "Surname4", 150)
book5 = Book(library2, "2022-07-01", "Author5", "Surname5", 180)

order1 = Order(employee1, "Student1", [book1, book2, book3], "2022-08-01")
order2 = Order(employee2, "Student2", [book4, book5], "2022-09-01")
